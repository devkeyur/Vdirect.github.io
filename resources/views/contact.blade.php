...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div style="text-align: center;">
      ...
      <p><i class="fas fa-envelope-open-text" style="color:#2C3E50; font-size:20px"></i> <b><i> <span id="W_Email"><a href="mailto:200510101130@paruluniversity.ac.in">TUSHAR RAJ 200510101130@paruluniversity.ac.in</a></span></i></b><br>
      <p><i class="fas fa-envelope-open-text" style="color:#2C3E50; font-size:20px"></i> <b><i> <span id="W_Email"><a href="mailto:200510101070@paruluniversity.ac.in">KEYUR MALETE 200510101070@paruluniversity.ac.in</a></span></i></b><br>
      <p><i class="fas fa-envelope-open-text" style="color:#2C3E50; font-size:20px"></i> <b><i> <span id="W_Email"><a href="mailto:200510101128@paruluniversity.ac.in">ARYAN RADADIYA 200510101128@paruluniversity.ac.in</a></span></i></b><br>
